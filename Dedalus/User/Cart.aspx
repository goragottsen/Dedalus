<%@ Page Title="Cart" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="Cart.aspx.cs" Inherits="_Default" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <p>Not happy with your order? Or just want to start over? <asp:Button ID="btnClearCart" runat="server" Text="Delete Order" OnClick="btnClearCart_Click" />   
