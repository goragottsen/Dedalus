<%@ Page Title="Profile" Language="C#" MasterPageFile="~/Moderator/MasterPage.master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        <h1 style="padding-top: 15px">Hi <asp:Label ID="username" runat="server" Text=""></asp:Label></h1>
